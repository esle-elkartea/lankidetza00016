 ...
 */
public class PriorityUserType implements UserType {
	...
	public Object nullSafeGet(ResultSet resultSet, String[] names, Object owner)
		...
		return resultSet.wasNull() ? null : Priority.get(value);
	}
	...
	public void nullSafeSet(PreparedStatement statement, Object value, int index)
		...
		if (value == null) {
			...
			statement.setByte(index, (byte) priority.getValue() );
		}
	}
}