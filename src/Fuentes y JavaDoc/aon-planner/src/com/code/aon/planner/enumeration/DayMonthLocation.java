...
/**
 * Enumeración para identificar las diferentes posiciones del día dentro del mes.
 * 
 ...
 * @since 1.0
 */
public class DayMonthLocation implements Serializable, Comparable {
     ...
     */
    private static DayMonthLocation[] ALL = new DayMonthLocation[LENGTH];
     ...
     */
    private static final String MSG_KEY_PREFIX = "aon_enum_day_location_";

    /**
     * Primer.
     */
    public static final DayMonthLocation FIRST = new DayMonthLocation(0);

    /**
     * Segundo.
     */
    public static final DayMonthLocation SECOND = new DayMonthLocation(1);

    /**
     * Tercer.
     */
    public static final DayMonthLocation THIRD = new DayMonthLocation(2);

    /**
     * Cuarto.
     */
    public static final DayMonthLocation FOURTH = new DayMonthLocation(3);

    /**
     * Ultimo.
     */
    public static final DayMonthLocation LAST = new DayMonthLocation(4);
    ...
    /**
     * Constructor for DayMonthLocation
     * 
     * @param index
     *            int
     */
    private DayMonthLocation(int index) {
        this.index = index;
        ALL[index] = this;
    }
    ...
    public boolean equals(Object obj) {
        if (obj instanceof DayMonthLocation) {
            DayMonthLocation as = (DayMonthLocation) obj;
    ...
    public int compareTo(Object obj) {
        return compareTo((DayMonthLocation) obj);
    }
     ...
     * @see java.lang.Comparable#compareTo(Object)
     */
    private int compareTo(DayMonthLocation ds) {
        if (this == ds) {
            return 0;
        }
     ...
     */
    public static DayMonthLocation get(byte b) {
        if (b < 0 || b >= ALL.length) {
     ...
     * @return El tipo de estado del evento.
     */
    public static DayMonthLocation get(String name, Locale locale) {
        Iterator iter = getList().iterator();
        while (iter.hasNext()) {
            DayMonthLocation element = (DayMonthLocation) iter.next();
    ...
    /**
     * Devuelve una lista no modificable los enumerados de <code>DayMonthLocation</code>.
     *  
     * @return
     */
